...
export const translations = {
  zh: {
    ...
    algebraInputPlaceholder: '输入 a=1 或 f(x)=x^2',
    ...
    shear: '剪切',
    stretch: '拉伸',
    shearFactorPrompt: '请输入剪切系数',
    stretchFactorPrompt: '请输入拉伸系数',
    panView: '平移视图',
  ...
  en: {
    ...
    algebraInputPlaceholder: 'Enter a=1 or f(x)=x^2',
    ...
    affineTransforms: 'Shear / Stretch',
    ...
    shear: 'Shear',
    stretch: 'Stretch',
    shearFactorPrompt: 'Enter the shear factor',
    stretchFactorPrompt: 'Enter the stretch factor',
    panView: 'Pan View',
